...
sprnvc#539{sprnvc(n, nzv, nn1, vc, ivc)}
...
/*************** Clava msgError **************
Loop contains Invalid Statement -> exit#705
****************************************/
for(i = 0; i < n; i++) {
...
cont40 = 0;
/*************** Clava msgError **************
Loop contains Invalid Statement -> BreakStmt#683
****************************************/
for(k = rowstr[j]; k < rowstr[j + 1]; k++) {
...
int was_gen = 0;
/*************** Clava msgError **************
Loop contains Invalid Statement -> BreakStmt#779
****************************************/
for(ii = 0; ii < nzv; ii++) {
