...
printf#249{printf(" Time step %4d\n", step)}
adi#251{adi()}
****************************************/
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#330{exact_solution(xi, eta, zeta, u_exact)}
****************************************/
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#439{exact_solution(xi, eta, zeta, dtemp)}
****************************************/
for(k = 1; k <= grid_points[2] - 2; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#511{exact_solution(xi, eta, zeta, dtemp)}
****************************************/
for(k = 1; k <= grid_points[2] - 2; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#583{exact_solution(xi, eta, zeta, dtemp)}
****************************************/
for(j = 1; j <= grid_points[1] - 2; j++) {
eta = (double) (j) * dnym1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#729{exact_solution((double) ix, eta, zeta, Pface[ix][0])}
exact_solution#734{exact_solution(xi, (double) iy, zeta, Pface[iy][1])}
exact_solution#739{exact_solution(xi, eta, (double) iz, Pface[iz][2])}
****************************************/
for(k = 0; k <= grid_points[2] - 1; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#768{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(k = 0; k <= grid_points[2] - 1; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#789{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(k = 0; k <= grid_points[2] - 1; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#810{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(k = 0; k <= grid_points[2] - 1; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#831{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(k = 0; k <= grid_points[2] - 1; k++) {
zeta = (double) (k) * dnzm1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#852{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(j = 0; j <= grid_points[1] - 1; j++) {
eta = (double) (j) * dnym1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
exact_solution#873{exact_solution(xi, eta, zeta, temp)}
****************************************/
for(j = 0; j <= grid_points[1] - 1; j++) {
eta = (double) (j) * dnym1;
/*************** Clava msgError **************
...
/*************** Clava msgError **************
consoleOutput
/tmp/clava_api/petit: AddSSAgraph: too many SSA graph nodes
