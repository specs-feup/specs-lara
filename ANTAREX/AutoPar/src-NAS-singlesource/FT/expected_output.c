...
fftXYZ#214{fftXYZ(-1, 128, 128, 32, xnt, (dcomplex *) xnt, exp1, exp2, exp3)}
CalculateChecksum#215{CalculateChecksum(&sums[kt], kt, 128, 128, 32, xnt)}
****************************************/
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
vranlc#371{vranlc(2 * d1, &x0, a, (double *) tmp)}
****************************************/
for(k = 0; k < d3; k++) {
x0 = RanStarts[k];
/*************** Clava msgError **************
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
Swarztrauber#527{Swarztrauber(sign, log, len, n1, blkp, plane, exp1)}
****************************************/
for(k = 0; k < n3; k++) {
/*************** Clava msgError **************
loop-step expression is not in canonical form
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
Swarztrauber#556{Swarztrauber(sign, log, len, n2, n1 + 1, &x[k][0][bls], exp2)}
****************************************/
for(k = 0; k < n3; k++) {
/*************** Clava msgError **************
loop-step expression is not in canonical form
...
/*************** Clava msgError **************
Variables Access as passed arguments Can not be traced inside of function calls :
Swarztrauber#585{Swarztrauber(sign, log, len, n3, blkp, plane, exp3)}
****************************************/
for(k = 0; k < n2; k++) {
/*************** Clava msgError **************
loop-step expression is not in canonical form
...
if(*verified) {
/*************** Clava msgError **************
Loop contains Invalid Statement -> BreakStmt#761
****************************************/
for(kt = 1; kt <= nt; kt++) {
