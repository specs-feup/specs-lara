...
int main(int argc, char * argv[]) {
    ...
    ****************************************/
    ...
    r_init#472{r_init((double *) ta1, ntot, 0.0)}
    timer_start#484{timer_start(1)}
    convect#487{convect(ifmortar)}
    transf#489{transf(tmort, (double *) ta1)}
    r_init#502{r_init((double *) tm1_80, (5 * 5 * 5), 0.0)}
    r_init#516{r_init((double *) tm2_80, (5 * 5 * 5), 0.0)}
    r_init#530{r_init((double *) ta2[ie], (5 * 5 * 5), 0.0)}
    transfb#574{transfb(rmor, (double *) trhs)}
    diffusion#634{diffusion(ifmortar)}
    add2#636{add2((double *) ta1, (double *) t, ntot)}
    adaptation#641{adaptation(&ifmortar, step)}
    ****************************************/
...
void do_coarsen(int * if_coarsen, int * icoarsen, int neltold) {
    ...
    ****************************************/
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    remapx#1010{remapx(ta1[ntp[0]], ta1[ntp[1]], temp1_100)}
    remapx#1011{remapx(ta1[ntp[2]], ta1[ntp[3]], temp2_100)}
    remapx#1012{remapx(ta1[ntp[4]], ta1[ntp[5]], temp3_100)}
    remapx#1013{remapx(ta1[ntp[6]], ta1[ntp[7]], temp4_100)}
    remapy#1014{remapy(temp1_100, temp2_100, temp5_100)}
    remapy#1015{remapy(temp3_100, temp4_100, temp6_100)}
    remapz#1016{remapz(temp5_100, temp6_100, ta1[ielnew_100])}
    ****************************************/
...
void do_refine(int * ifmortar, int * irefine) {
    ...
    ****************************************/
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    ncopy#1145{ncopy((int *) ijeltemp, ijel[iel][0], 12)}
    ncopy#1146{ncopy((int *) sjetemp, sje[iel][0][0], 24)}
    copy#1147{copy((double *) ta1temp, ta1[iel][0][0], (5 * 5 * 5))}
    remap#1486{remap(ta1[iel], &ta1[ref_front_id[iel]], ta1temp)}
    ****************************************/
...
void check_refine(int * ifrepeat) {
    ...
    *ifrepeat = 0;
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    ifcor#1649{ifcor(iel, nntemp, i, iface)}
    ****************************************/
    for(iel = 0; iel < nelt; iel++) {
...
void diffusion(int ifmortar) {
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    adds1m1#2443{adds1m1((double *) pdiff, (double *) pdiffp, beta, ntot)}
    transf#2454{transf(pmorx, (double *) pdiff)}
    r_init#2466{r_init((double *) tm1_81, (5 * 5 * 5), 0.0)}
    r_init#2480{r_init((double *) tm2_81, (5 * 5 * 5), 0.0)}
    r_init#2494{r_init((double *) pdiffp[ie], (5 * 5 * 5), 0.0)}
    transfb#2521{transfb(ppmor, (double *) pdiffp)}
    adds2m1#2599{adds2m1((double *) t, (double *) pdiff, cona, ntot)}
    adds2m1#2609{adds2m1((double *) trhs, (double *) pdiffp, -cona, ntot)}
    ****************************************/
...
void mortar() {
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    get_emo#3810{get_emo(ntempx_102[0], count_102, 7)}
    get_emo#3816{get_emo(ntempx_102[1], count_102, 6)}
    get_emo#3822{get_emo(ntempx_102[2], count_102, 5)}
    get_emo#3828{get_emo(ntempx_102[3], count_102, 4)}
    get_emo#3834{get_emo(ntempx_102[4], count_102, 3)}
    get_emo#3840{get_emo(ntempx_102[5], count_102, 2)}
    get_emo#3846{get_emo(ntempx_102[6], count_102, 1)}
    get_emo#3852{get_emo(ntempx_102[7], count_102, 0)}
    ****************************************/
    for(iel = 0; iel < nelt; iel++) {
    ...
    ****************************************/
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    mor_s_e_nn#4970{mor_s_e_nn(op[edge_79], jjface[face_79], iel_79, mor_s_v_79, nn_79)}
    mor_s_e_nn#4971{mor_s_e_nn(op[edge2_79], jjface[face2_79], iel_79, mor_s_v_79, nn_79)}
    ****************************************/
    for(iel = 0; iel < nelt; iel++) {
        front[iel] = front[iel] - newc[iel];
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    nr_init#5042{nr_init((int *) mor_s_v_101, 4 * 2, -1)}
    mor_s_e#5052{mor_s_e(0, face_101, iel_101, mor_s_v_101)}
    mor_s_e#5056{mor_s_e(edge_l_101, face2_101, iel_101, mor_s_v_101)}
    mor_s_e#5067{mor_s_e(1, face_101, iel_101, mor_s_v_101)}
    mor_s_e#5071{mor_s_e(edge_l_101, face2_101, iel_101, mor_s_v_101)}
    mor_s_e#5082{mor_s_e(2, face_101, iel_101, mor_s_v_101)}
    mor_s_e#5086{mor_s_e(edge_l_101, face2_101, iel_101, mor_s_v_101)}
    mor_s_e#5096{mor_s_e(3, face_101, iel_101, mor_s_v_101)}
    mor_s_e#5100{mor_s_e(edge_l_101, face2_101, iel_101, mor_s_v_101)}
    ****************************************/
    for(iel = 0; iel < nelt; iel++) {
        /*************** Clava msgError **************
        Loop Iteration number is too low
    ...
    for(element_size = 0; element_size < 5; element_size++) {
        ...
        ****************************************/
        for(j = 0; j < 5 / 2 + 1; j++) {
            /*************** Clava msgError **************
            Variables Access as passed arguments Can not be traced inside of function calls :
            r_init#6170{r_init((double *) p, (5 * 5 * 5), 0.0)}
            r_init#6179{r_init((double *) tm1_82, (5 * 5 * 5), 0.0)}
            r_init#6193{r_init((double *) tm2_82, (5 * 5 * 5), 0.0)}
            r_init#6207{r_init((double *) temp, (5 * 5 * 5), 0.0)}
            ****************************************/
            for(i = j; i < 5 / 2 + 1; i++) {
        ...
        ****************************************/
        for(j = 1; j < 5; j++) {
            /*************** Clava msgError **************
            Variables Access as passed arguments Can not be traced inside of function calls :
            r_init#6253{r_init((double *) mtemp, 5 * 5, 0.0)}
            r_init#6254{r_init((double *) p, (5 * 5 * 5), 0.0)}
            transf_nc#6264{transf_nc(mtemp, (double (*)[5]) p)}
            r_init#6272{r_init((double *) tm1_83, (5 * 5 * 5), 0.0)}
            r_init#6286{r_init((double *) tm2_83, (5 * 5 * 5), 0.0)}
            r_init#6300{r_init((double *) temp, (5 * 5 * 5), 0.0)}
            transfb_nc1#6324{transfb_nc1(temp1, (double (*)[5]) temp)}
            ****************************************/
            for(i = j; i < 5; i++) {
...
void setpcmo() {
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    com_dpc#7827{com_dpc(iside, iel, _enum, 1, sizei)}
    com_dpc#7833{com_dpc(iside, iel, _enum, 2, sizei)}
    com_dpc#7843{com_dpc(iside, iel, _enum, 3, sizei)}
    com_dpc#7850{com_dpc(iside, iel, _enum, 4, sizei)}
    com_dpc#7856{com_dpc(iside, iel, _enum, 0, sizei)}
    ****************************************/
    for(iel = 0; iel < nelt; iel++) {
        /*************** Clava msgError **************
        Loop Iteration number is too low
...
void transf(double tmor[], double tx[]) {
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    r_init#9304{r_init((double *) tmp, 5 * 5 * 2, 0.0)}
    ****************************************/
    for(ie = 0; ie < nelt; ie++) {
        /*************** Clava msgError **************
        Loop Iteration number is too low
...
void transfb(double tmor[], double tx[]) {
    ...
    /*************** Clava msgError **************
    Variables Access as passed arguments Can not be traced inside of function calls :
    r_init#9570{r_init((double *) temp, 5 * 5 * 2, 0.0)}
    ****************************************/
    for(ie = 0; ie < nelt; ie++) {
        /*************** Clava msgError **************
        Loop Iteration number is too low
