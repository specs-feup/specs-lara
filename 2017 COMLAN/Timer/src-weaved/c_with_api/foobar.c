...
double foo() {
   ...
   for(int i = 0; i < 1000; i++) {
      ...
      double clava_timing_duration_0 = ((clava_timing_end_0.QuadPart-clava_timing_start_0.QuadPart) / (double)clava_timing_frequency_0.QuadPart) * (1000000);
...
int main() {
   ...
   double clava_timing_duration_1 = ((clava_timing_end_1.QuadPart-clava_timing_start_1.QuadPart) / (double)clava_timing_frequency_1.QuadPart) * (1000000);
